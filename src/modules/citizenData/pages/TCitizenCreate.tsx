...
import { BsPlus, BsPencilSquare, BsPersonCheckFill, BsPersonDashFill, BsPerson, BsSearch, BsListTask, BsLayoutWtf } from "react-icons/bs";
import { Toast } from "../../../utils/Toastify";
import { MenuItem, SpeedDial, SpeedDialAction, TextField, ButtonGroup, Table, ThemeProvider, InputAdornment, IconButton, Tooltip, Paper, TableContainer, TableHead, TableRow, TableCell, TableBody, TablePagination } from "@mui/material";
...
import { MCreateCitizen } from '../components/MCreateCitizen'

interface ITCitizenCreate { }

const _globalService = new GlobalService();
const _adminService = new AdminService();

export const TCitizenCreate: React.FC<ITCitizenCreate> = (props: ITCitizenCreate) => {
                        ...
                        <div className="row">
                            <div className="p-0">
                                ...
                                <div className="mt-3">
                                    ...
                                    {show &&
                                        <MCreateCitizen dataTitle={title} show={show} setShow={setShow} getAccount={getAccountByNit2} dataObj={formdata} />
                                    }
                                    {/* {show &&
                                    <NEUser
                                        getShow={closeModal}
