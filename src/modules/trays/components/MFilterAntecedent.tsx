...
interface IMFilterAntecedent {
  getShowMFilterAntecedent: Function;
  dataShowMFilterAntecedent: boolean;
  /* dataList: any[]; */
}

export const MFilterAntecedent: React.FC<IMFilterAntecedent> = (
  props: IMFilterAntecedent
) => {
  ...
  const closeModal = () => {
    props.getShowMFilterAntecedent(false);
  };
  ...
  return (
    <Modal
      show={props.dataShowMFilterAntecedent}
      onHide={closeModal}
      size="lg"
      centered 
    >
